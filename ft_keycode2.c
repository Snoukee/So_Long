...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/04/18 19:02:21 by ifreire-          #+#    #+#             */
/*   Updated: 2022/04/20 02:06:32 by ifreire-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_nospace2(t_map *map, int i)
{
	if (i == 0)
	{
	...
	{
		mlx_put_image_to_window(map->mlx, map->win, map->player2, \
		map->x * 32, map->y * 32);
		i = 0;
	}
